...
if not index.exists() :
	...
	store        = FAISSDocumentStore( embedding_dim=128, faiss_index_factory_str="Flat", sql_url=URL.replace( '##DB##', str( db ) ) )
	...
	retriever = DensePassageRetriever( document_store=store, query_embedding_model="vblagoje/dpr-question_encoder-single-lfqa-wiki", passage_embedding_model="vblagoje/dpr-ctx_encoder-single-lfqa-wiki" )
